...
CX = CY = 140
BATT_Y, DATE_Y, TIME_Y, SAT_Y = 22, 56, 74, 104
BATT_X, DATE_X = 133, 48
LABEL_X, COL2_X, SAT_X, TIME_X = 34, 176, 178, 23
...
TIME_BASE = 10 + 37   # Archivo 900 wdth 90, 52
...
L.append(text("time", TIME_X, TIME_Y + TIME_BASE, "18:13", 52, TIME_SX, family="Archivo", weight=900, stretch="90%"))
