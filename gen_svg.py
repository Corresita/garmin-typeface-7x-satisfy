...
CX = CY = 140
BATT_Y, DATE_Y, TIME_Y, SAT_Y = 18, 48, 60, 105
LABEL_X, COL2_X = 40, 182
...
L.append(text("sun time", bx + 29, by + 2 + TEXT_BASE, "18:13", 21, TEXT_SX))
...
L.append(text("date", LABEL_X, DATE_Y + TEXT_BASE, "THU.09.10", 21, TEXT_SX))
L.append(text("time", LABEL_X - 3, TIME_Y + TIME_BASE, "12:17", 78, TIME_SX))
